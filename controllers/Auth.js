...
exports.signup = async (req, res) => {
  try {
    const { username, email, password, confirmPassword, userType, otp } =
      req.body;

    if (!username || !email || !password || !userType || !otp) {
    ...
    let approved = "";
    approved === "Admin" ? (approved = true) : (approved = false);
...
// Login controller for logging in users
